namespace ZooAPI
{
    ...
    public class Program
    {
        ...
        private static void Configure(WebApplication app)
        {
            ...
            // Kassierer-Endpunkte 
            app.MapControllers();
            app.MapControllerRoute("kassierer", "api/kassierer/{controller=Home}/{action=Index}/{id?}"); // Kassierer-Endpunkte

            // Tierpfleger-Endpunkte 
            app.MapControllerRoute("tierpfleger", "api/tierpfleger/{controller=Home}/{action=Index}/{id?}");  // Tierpfleger-Endpunkte
